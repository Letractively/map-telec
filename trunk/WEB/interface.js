...
function Separator( id, root_node, orientation, gr_node1, gr_node2, taille_ref){
	...
	Draggable(id, [id], null, function(n, e) {
		...
		if(orientation=='vertical')
			document.getElementById('draggableseparatornordsud').setAttribute('width',window.innerWidth-size-window.innerWidth/60);
		str_mtx = 'matrix(' + M.a 
						+ ', ' + M.b
						+ ', ' + M.c
						+ ', ' + M.d
		...
		for(i=0;i<gr_node2.length;i++){
			gr_node2[i].setAttribute('transform', str_mtx);
...
function List(root_node, dec,orientation){
	...
	this.remove = function(e){
		...
		if(this.orientation == 'vertical'){
			...
			str_trans = ' translate(0,'+y+')';
			} else  {	var x = -(bbox_e.width+this.dec);
						str_trans = ' translate('+x+', 0)';
					}
...
//______________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
function init_users(){
	var u1 = new User("user1","img/user1.png",null, 'user1');
	...
	var u2 = new User("user2","img/user2.png",null, 'user2');
	...
	var u3 = new User("user3","img/user3.png",null, 'user3');
	...
	var u4 = new User("user4","img/user4.png",null, 'user4');
	...
	var u5 = new User("user5","img/user5.png",null, 'user5');
